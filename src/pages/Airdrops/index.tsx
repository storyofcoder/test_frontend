...
const BuyNowButton = styled.div<{
  ...
  max-width: 300px;
  margin-left: auto;
  background-color: ${({ theme, useAccentColor }) =>
    useAccentColor ? theme.accent1 : theme.surface3};
  border-radius: 12px;
  padding: 10px 12px;
...
const Airdrops = ({ initialTab }: { initialTab?: ExploreTab }) => {
          ...
          <TitleContainer>
            <Link to="/create-airdrop">
              ...
              >
                <ThemedText.SubHeader color="white" lineHeight="20px">
                  <span data-testid="nft-details-toggle-bag">{'Create Airdrop'}</span>
            ...
            >
              <ThemedText.LargeHeader>
                <Trans>Top Free Airdrops List</Trans>
              </ThemedText.LargeHeader>
            </MouseoverTooltip>
          </TitleContainer>
        )}
