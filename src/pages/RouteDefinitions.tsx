...
import CreateTokenPage from './CreateToken'
import CreateTokenSalePage from './CreateTokenSale'
import CreateAirDropPage from './CreateAirDrop'
...
export const routes: RouteDefinition[] = [
  ...
  createRouteDefinition({ path: '/create', getElement: () => <CreateTokenPage /> }),
  createRouteDefinition({ path: '/create-token-sale', getElement: () => <CreateTokenSalePage /> }),
  createRouteDefinition({ path: '/token-sale', getElement: () => <TokenSalePage /> }),
  createRouteDefinition({ path: '/create-airdrop', getElement: () => <CreateAirDropPage /> }),
  createRouteDefinition({ path: '/airdrops', getElement: () => <Airdrops /> }),
