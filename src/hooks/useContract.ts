...
import SUNDEEP_ABI from 'abis/sundeep/sundeep.json'
...
export function useSundeepContract(withSignerIfPossible?: boolean) {
  const { chainId } = useWeb3React()
  return useContract(
    chainId ? "0xCe5f5Ed7BcB9A3D01f395F7bb09602a4792F8C20" : undefined,
    SUNDEEP_ABI,
    withSignerIfPossible
  )
}
